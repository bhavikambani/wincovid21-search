...
public class ResourceDaoImpl implements ResourceDao {
    ...
    private ResourceModel getResourceModelFromJson(JSONObject jsonObject) {
        ...
        resourceModel.setCategory((Long) jsonObject.get(Constant.CATEGORY));
        resourceModel.setSubcategory((Long) jsonObject.get(Constant.SUBCATEGORY));
        ...
        resourceModel.setCity((Long) jsonObject.get(Constant.CITY));
        resourceModel.setState((Long) jsonObject.get(Constant.STATE));
