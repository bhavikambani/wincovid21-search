...
public class ResourceDaoImpl implements ResourceDao {
    ...
    private ResourceModel getResourceModelFromJson(JSONObject jsonObject) {
        ...
        resourceModel.setCategoryId((Long) jsonObject.get(Constant.CATEGORYID));
        resourceModel.setSubcategory((String) jsonObject.get(Constant.SUBCATEGORY));
        resourceModel.setSubcategoryId((Long) jsonObject.get(Constant.SUBCATEGORYID));
        ...
        resourceModel.setCityId((Long) jsonObject.get(Constant.CITYID));
        resourceModel.setState((String) jsonObject.get(Constant.STATE));
        resourceModel.setStateId((Long) jsonObject.get(Constant.STATEID));
